...
export function Gradient() {
  return (
    <div className="relative gradient-section flex justify-center items-center bg-gradient-to-b from-transparent to-white text-center text-black mt-8 px-4 mb-20" style={{ position: 'absolute', top: 950 , width: '100%', zIndex: 10 }}>
